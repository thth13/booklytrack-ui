  ...
  return (
    <div className="mt-6 space-y-3">
      <Menu as="div" className="relative">
        {currentCategory ? (
          <MenuButton className="w-full px-4 py-2.5 bg-blue-100 text-blue-700 rounded-lg flex items-center justify-between whitespace-nowrap">
          ...
          <MenuButton className="w-full px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center justify-between">
            <span className="flex items-center">
